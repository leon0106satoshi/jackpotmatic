...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/euro_slot/body/bootstrap.min.css" />
    {{-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" /> --}}
    {{-- <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js"></script> --}}
    <script src="/euro_slot/body/popper.min.js"></script>
    <script src="/euro_slot/body/bootstrap.min.js"></script>
    {{-- <script src="/assets/_new-style/js/jquery.1.8.2.min.js"></script> --}}
    {{-- <script type="text/javascript" src="/assets/_new-style/js/angular.min.js"></script> --}}
    <!--[if lt IE 9]>
    <script src="/assets/_new-style/js/html5shiv.min.js"></script>
    <script src="/assets/_new-style/js/respond.min.js"></script><![endif]-->

    <!-- DEFAULT CSS -->
    {{--
    <link href="/assets/_new-style/css/reset.css" rel="stylesheet" type="text/css" class="styles" /> --}}
    <!-- Flags -->
    {{--
    <link rel="stylesheet" href="/assets/plugins/flag-icon-css/css/flag-icon.min.css"> --}}
    <!-- Perfect scrollbar css -->
    {{--
    <link rel="stylesheet" type="text/css" href="/assets/_new-style/css/perfect-scrollbar.css"> --}}
    <!-- zebra datepicker -->
    {{--
    <link rel="stylesheet" type="text/css" href="/assets/_new-style/css/zebra_datepicker.css"> --}}
    <!-- START OF ALL CUSTOM CSS + FONTS -->
    {{--
    <link href="/assets/_new-style/css/style.css" rel="stylesheet" type="text/css" /> --}}
    {{--
    <link href="/assets/_new-style/css/regional.css" rel="stylesheet" type="text/css" /> --}}
    {{--
    <link rel="stylesheet" href="/assets/_new-style/css/oct7vfe.css"> --}}
    ...
    <!-- DEFAULT JS SCRIPTS -->
    <!--[if lt IE 9]>
    <script src="/assets/_new-style/js/html5-shiv.js" type="text/javascript"></script>
    <![endif]-->
    {{-- <script src="/assets/js/sweetalert.min.js" type="text/javascript"></script> --}}
    <link rel="stylesheet" type="text/css" href="/euro_slot/src/js_src/jackpot_toolbar/css/styles.css" />

    <script src="/euro_slot/src/js/is.js"></script>
    <script src="/frontend/euroslots/js/toastr.min.js"></script>
</head>


<body class="en" ng-app="app" ng-controller="gameCtrl" id="" allowfullscreen>
   ...
   <script>
    ...
    <div id="jackpotsdiv" style="z-index:2000; height:6.5vh; pointer-events: none;">
        <div id="jackpot-bar">
            ...
            <div id="jackpot2"></div>
            <div id="jackpot3"></div>
            <script type="text/javascript" src="/euro_slot/src/js_src/jackpot_toolbar/AmatJP.js"></script>
            <script type="text/javascript">
    ...
    {{-- <script type="text/javascript" src="/assets/_new-style/js/jquery-1.7.1.min.js"></script>
    <script type="text/javascript" src="/assets/_new-style/js/jquery.corsproxy.1.0.0.js"></script>
    <script type="text/javascript" src="/assets/_new-style/js/perfect-scrollbar.jquery.js"></script>
    <script type="text/javascript" src="/assets/_new-style/js/zebra_datepicker.min.js"></script> --}}
    {{-- DataTables --}}
    ...
    {{-- <script type="text/javascript" src="/assets/_new-style/js/app.js"></script>
    <script type="text/javascript" src="/assets/_new-style/js/angular-lazy-img.min.js"></script>
    <script type="text/javascript" src="/assets/_new-style/js/gameController.js"></script> --}}
    <script>
