...
<html  lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="/frontend/euroslots/src/js_src/jackpot_toolbar/css/styles.css" />
    <link rel="stylesheet" type="text/css" href="/frontend/euroslots/css/style.css" />
    ...
    <script src="/frontend/euroslots/src/js/is.js"></script>
...
<body onClick="AhmetOnurSlmzoynat();" class="en" ng-app="app" ng-controller="gameCtrl" >
   ...
   <audio id="pl">
  <source src="/frontend/euroslots/mp3/slide.mp3" type="audio/mpeg">
</audio>
<script>
...
<div id="rotate" /></div>
    <div id="jackpotsdiv" style="z-index:2000; height:6.5vh; pointer-events: none;">
        <div id="jackpot-bar">
            ...
            <div id="jackpot2"></div>
            <div id="jackpot3"></div>
            <script type="text/javascript" src="/frontend/euroslots/src/js_src/jackpot_toolbar/AmatJP.js"></script>
            <script type="text/javascript">
...
<section id="content">
    ...
    <header class="v-middle">
        ...
        <div class="v-middle">
               <ul onClick="click();" class="nav-ui" id="cat-menu" style="transition:0.3s;">
                ...
                <li class="v-middle @if($category->href==$category1) active @endif">
                    <a class="providers__link" href="{{ route('frontend.game.list.category', $category->href) }}">
                        <span class="providers__name">{{ $category->title }}</span>
                    </a>
                </li>
                @endforeach
                @endif
            ...
            <span  class="logo" id="logo">
                 <img src="/frontend/euroslots/img/logo.png" alt="logo" class="logo">
                </span>
            <style>
                .ortalama {
 ...
 margin-left:38% ;
                ...
                <div class="game-item__overlay ng-scope">
                    <div class="game-item__actions">
                        ...
                        <a href="{{ route('frontend.game.go', $game->name) }}?api_exit=/" class="button button-primary ng-scope ng-binding">
                            <img src="/frontend/euroslots/img/play_small.png" alt="">
                        </a>
                        @else
    ...
    <img src="/frontend/euroslots/img/leftarrow.png" class="prev arrow-button" id="sol" alt="" onclick="arrowDecrease()">
    <img src="/frontend/euroslots/img/rightarrow.png" class="next arrow-button"  id="sag" alt="" onclick="arrowIncrease()">
	...
	<!-- <div id="tamekran" style='display:none'
	     onclick="myFunction()"   style="background-image: url('/frontend/euroslots/img/tap.png');">
	</div>  -->
...
<script type="text/javascript" src="/frontend/euroslots/js/script.js"></script>
<script src="/frontend/euroslots/js/custom.js"></script>
<script>
