...
document.location.href=exitUrl;	
 ...
 <script src="/frontend/BlueShop/js/jquery.min.js?v=2.0"></script>
    <script src="/frontend/BlueShop/js/jquery-ui.min.js"></script>
    <link rel="stylesheet" href="/frontend/BlueShop/css/bonus.css">
</head>
<body>
	...
	<script type="text/javascript" src="./src/goldenjokerloader_00217028.js"></script>
		<script type="text/javascript" src="/frontend/BlueShop/js/bonus.js"></script>
</body>
</html>