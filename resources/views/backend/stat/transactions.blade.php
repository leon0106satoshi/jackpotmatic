...
<div class="heye ">
    <div class="kutu">
<p class="h2 "><strong>SHOP KONTOSTAND: &nbsp;&nbsp; {{number_format($shopguthaben,2)}} </strong> </p>
</div>
                        ...
                        <div class="row row-sm text-center">
                            <div class=" col-lg-3">
                                <div class="panel padder-v item bg-success">
                                    <div class="h3 text-info font-thin h3">AUFGELADENS GUTHABEN<br>(An Shop Bezahlt)</div>
                                    
                                    <span title="" data-original-title="Total active this month" class="h3">{{number_format($totoalx,2)}}
                                    </span>
                                </div>
                            </div>
                            <div class=" col-lg-3">
                                <div class="panel padder-v item bg-green">
                                    <div class="h3 text-info font-thin h3">MONEY IN<br>(Von Spieler erhalten)</div>
                                    <span title="" data-original-title="Total active this month" class="h3">{{number_format($monyin,2)}}
                                    </span>
                                </div>
                            </div>
                             <div class=" col-lg-3">
                                <div class="panel padder-v item bg-red">
                                    <div class="h3 text-white font-thin h3">MONEY OUT<br>(An Spieler ausbezahlt)</div>
                                    <span title="" data-original-title="Total active this month" class="h3">{{number_format($monyout,2)}}
                                    </span>
                                </div>
                            </div>
                             <div class=" col-lg-3">
                                <div class="panel padder-v item bg-info">
                                    <div class="h3 text-info font-thin h3">TOTAL<br>(Shop Gewinne)</div>
                                    <span title="" data-original-title="Total active this month" class="h3">{{number_format($totoalx,2)}}
                                    </span>
                                </div>
