                        ...
                        <div class="row row-sm text-center">
                            <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-warning">
                                    <div class="h1 text-info font-thin h1">{{ number_format($stats['games']) }}</div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><p>Disabled Games: {{ number_format($stats['disabled']) }}</p>
                                   <div class="icon">
						<i class="fa fa-star"></i>
                             ...
                             <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-primary">
                                    <div class="h1 text-info font-thin h1">{{ $percent }}<sup style="font-size: 20px">%</sup></div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><p>@lang('app.average_RTP'): {{ number_format( $stats['rtp'], 2 ) }}</p>
                                   <div class="icon">
						<i class="fa fa-area-chart"></i>
                             ...
                             <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-info">
                                    <div class="h1 text-white font-thin h1">{{ $stats['in'] }}</div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><p>@lang('app.total_in')</p><div class="icon">
						<i class="fa fa-level-up"></i>
                             ...
                             <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-danger">
                                    <div class="h1 text-info font-thin h1">{{ $stats['out'] }}</div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><p>@lang('app.total_out')</p>
                                    <div class="icon">
