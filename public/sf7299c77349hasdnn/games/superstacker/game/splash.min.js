...
! function(a) {
    ...
    ! function(a) {
        var b = function(a) {
            function b(b, c) {
                var d = a.call(this, b, null, "splash-background") || this;
                return d.triangles = [], d.triangleSizes = [350, 650, 950, 1250], d.back = d.game.make.graphics(0, 0), d.t = d.game.make.graphics(0, 0), d.gradientBitmap = d.game.make.bitmapData(1, 1), d.gradient = d.game.make.sprite(0, 0, d.gradientBitmap), d.add(d.back), d.add(d.t), d.add(d.gradient), d.resize(c), d
            }
            return __extends(b, a), b.prototype.resize = function(a) {
                var b = this,
                    c = this.game.width < 1 ? 1 : this.game.width,
                    d = this.game.height < 1 ? 1 : this.game.height;
                this.back.clear().beginFill(3387647).drawRect(0, 0, c, d), this.updateTrinagles(a), this.t.x = c / 2, this.t.y = d / 2, this.t.clear(), this.t.lineStyle(80 * a, 16777215, .3), this.triangles.forEach(function(a) {
                    b.t.drawPolygon(a)
                }), this.t.angle = 30, this.gradientBitmap.resize(c, d);
...
! function(a) {
    ...
    ! function(a) {
        var b = function(a) {
            function b(b, c) {
                var d = a.call(this, b, null, "splash-background") || this;
                return d.gradientBitmap = d.game.make.bitmapData(1, 1), d.gradient = d.game.make.sprite(0, 0, d.gradientBitmap), d.add(d.gradient), d.resize(c), d
            }
            return __extends(b, a), b.prototype.resize = function(a) {
                var b = this.game.width < 1 ? 1 : this.game.width,
                    c = this.game.height < 1 ? 1 : this.game.height;
...
! function(a) {
    ...
    ! function(a) {
        var b = function(a) {
            function b(b, c) {
                var d = a.call(this, b, null, "splash-background") || this;
                return d.back = d.game.make.graphics(0, 0), d.gradientBitmap = d.game.make.bitmapData(1, 1), d.gradient = d.game.make.sprite(0, 0, d.gradientBitmap), d.add(d.back), d.add(d.gradient), d.resize(c), d
            }
            return __extends(b, a), b.prototype.resize = function(a) {
                var b = this.game.width < 1 ? 1 : this.game.width,
                    c = this.game.height < 1 ? 1 : this.game.height;
...
! function(a) {
    ...
    var c = function() {
        ...
        return c.setSiteLock = function(a) {
            ...
            }, this)), e.visible = !c.isSpecial(b), e
            ...
            if (!c.siteLocks || !c.siteLocks.hasOwnProperty("admeen")) return !1;
            var a = c.siteLocks.admeen;
            return c.hostMatchesList(a)
        }, c.isKongregate = function() {
            if (!c.siteLocks || !c.siteLocks.hasOwnProperty("kongregate")) return !1;
            var a = c.siteLocks.kongregate;
            return c.hostMatchesList(a)
        }, c.isNewgrounds = function() {
            if (!c.siteLocks || !c.siteLocks.hasOwnProperty("newgrounds")) return !1;
...
! function(a) {
    var b = function() {
        ...
        return b.loadPortalScript = function(b) {
            ...
            }, addScript("https://ext.minijuegosgratis.com/external-host/main.js", Date.now() / 1e3)), b && b.hasOwnProperty("kongregate") && b.kongregate.indexOf(a.Utils.getSourceSite()) !== -1 && addScript("https://cdn1.kongregate.com/javascripts/kongregate_api.js", Date.now() / 1e3, function() {
...
! function(a) {
    var b;
    ! function(a) {
        a[a.Neutral = 0] = "Neutral", a[a.Yepi = 1] = "Yepi", a[a.Spele = 2] = "Spele", a[a.Funnygames = 3] = "Funnygames", a[a.Kizi = 4] = "Kizi", a[a.PlayCell = 5] = "PlayCell", a[a.GameCell = 6] = "GameCell", a[a.Bild = 7] = "Bild", a[a.Spil = 8] = "Spil", a[a.Admeen = 9] = "Admeen"
    ...
    ! function(b) {
        var c = function(b) {
            ...
            return __extends(c, b), c.prototype.setup = function(b, c, d, e) {
                ...
                ga("fbrq.send", "event", a, b, c), ga("send", "event", a, b, c)
            }, c
        }(Phaser.Plugin);
        b.GoogleAnalytics = c
    }(b = a.Plugins || (a.Plugins = {}))
    ...
    ! function(b) {
        var c = function(c) {
            ...
            return __extends(d, c), d.prototype.init = function(b) {
                ...
                a.Utils.ASSET_LOCATION = "", a.Utils.registerAudioUnlocker(this.game)
            ...
            }, d.prototype.loadUpdate = function() {}, d.prototype.update = function() {
...
! function(a) {
    ...
    ! function(b) {
        var c = function(c) {
            function d() {
                var a = c.call(this) || this;
                return a.name = d.Name, a.scaleFactor = 1, a.created = !1, a.preloadReady = !1, a.clicked = !1, a.dotText = ".", a.ts = 0, a
            }
            return __extends(d, c), d.prototype.init = function(a, b) {
                ...
                a.Utils.isOnDevice(this.game) || (this.preloadText.visible = !1, this.game.tweens.remove(this.buttonTween), this.playButton.scale.set(this.scaleFactor), this.playButton.visible = !0, this.buttonTween = this.game.add.tween(this.playButton.scale), this.buttonTween.to({
                ...
                this.game.scale.onSizeChange.remove(this.resize, this), this.game.load.onLoadStart.remove(this.onPreloadStart, this), this.game.load.onFileComplete.remove(this.onPreloadedFile, this), this.game.load.onLoadComplete.remove(this.onPreloadEnd, this), this.logo.destroy(!0), this.playButton.destroy(!0), this.bgImage.destroy(!0), this.background.destroy(!0), this.logo = null, this.bgImage = null, this.playButton = null, this.background = null, this.game.state.remove(b.Preloader.Name), this.game.state.remove(b.SplashPreloader.Name), this.game.state.remove(this.name)
            }, d
        }(Phaser.State);
    ...
    ! function(b) {
        var c = function(c) {
            ...
            return __extends(d, c), d.prototype.init = function(a, b) {
                ...
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.game.tweens.remove(this.buttonTween), this.playButton.scale.set(this.scaleFactor), this.playButton.visible = !0, this.buttonTween = this.game.add.tween(this.playButton.scale), this.buttonTween.to({
                    x: 1.14 * this.scaleFactor,
                    y: 1.14 * this.scaleFactor
                }, 420, Phaser.Easing.Quadratic.InOut, !0, 500), this.buttonTween.yoyo(!0).onComplete.add(this.animateButton, this), void this.buttonTween.start())
            }, d.prototype.update = function() {
                this.background.update()
            }, d.prototype.loadUpdate = function() {
                this.background.update()
        ...
        var c = function(c) {
            ...
            return __extends(d, c), d.prototype.init = function(a, b) {
                ...
                this.twirl = this.game.add.image(this.game.width / 2, this.game.height / 2, "gamecell_atlas", "gamecell_bg_pattern"), this.twirl.scale.setTo(2, 2), this.twirl.anchor.set(.5), this.createOverlay(), this.logoSpine = this.game.add.spine(0, 0, "splash_gamecell"), this.logoSpine.setAnimationByName(0, "idle", !0), this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 + 230, "", {
                    ...
                    fill: "#ffffff",
                    fontWeight: "bold"
                }), this.preloadText.anchor.set(.5), this.logo = this.game.add.image(0, 0, "gamecell_atlas", "gamecell_logo"), this.logo.anchor.set(.5), d.IdealWidth = 1.5 * this.logo.getBounds().width, this.playButton = this.game.add.button(this.game.width / 2, .85 * this.game.height, "gamecell_atlas", this.handler, this, "gamecell_btn_play", "gamecell_btn_play", "gamecell_btn_play", "gamecell_btn_play"), this.playButton.anchor.set(.5), this.playButton.scale.set(this.scaleFactor), this.playButton.visible = !1, this.created = !0
...
! function(a) {
    ...
    ! function(b) {
        var c = function(c) {
            function d() {
                var a = c.call(this) || this;
                return a.name = d.Name, a.scaleFactor = 1, a.created = !1, a.preloadReady = !1, a.clicked = !1, a.preloadTexts = ["Loading images", "Loading music", "Loading sound effects", "Calculating Pi"], a.dotText = ".", a.tId = 0, a
            }
            return __extends(d, c), d.prototype.init = function(a, b) {
                this.config = a, this.background = b, this.config.preloadTexts && (this.preloadTexts = this.config.preloadTexts), this.game.scale.onSizeChange.add(this.resize, this)
            }, d.prototype.preload = function() {
                ...
                this.twirl = this.game.add.image(this.game.width / 2, this.game.height / 2, "kizi_twist"), this.twirl.anchor.set(.5), this.twirl.width = this.twirl.height = this.game.width > this.game.height ? this.game.width : this.game.height, this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 + 230, "", {
                    font: "Arial",
                    fontSize: 40,
                    fill: "#ffffff",
                    fontWeight: "bold"
                }), this.preloadText.anchor.set(.5), this.playButton = this.game.add.button(this.game.width / 2, .85 * this.game.height, "kizi_button", this.handler, this, 0, 0, 1, 0), this.playButton.anchor.set(.5), this.playButton.scale.set(this.scaleFactor), this.playButton.visible = !1, this.created = !0
            }, d.prototype.handler = function(a, b) {
                if (!this.clicked && "mouseout" !== b.type) {
                    this.clicked = !0, this.game.tweens.remove(this.buttonTween), this.game.camera.fade(0, 250);
                    var c = this.game.add.tween(this.playButton.scale);
                ...
                this.created && (this.preloadText.y = .85 * this.game.height, this.preloadText.scale.set(this.scaleFactor), this.playButton.x = this.game.width / 2, this.playButton.y = .85 * this.game.height, this.twirl.position.set(this.game.width / 2, this.game.height / 2))
            }, d.prototype.getScale = function() {
                return a.Utils.isOnDevice(this.game) ? this.game.width < 1.5 * d.IdealWidth ? this.game.width / 6 * 4 / d.IdealWidth : 1 : this.game.width < this.game.height ? this.game.width / d.IdealWidth : this.game.width / 6 * 3 / d.IdealWidth
            }, d.prototype.startAnimation = function() {
                ...
                c.prototype.shutdown.call(this), this.playButton.destroy(!0), this.background.destroy(!0), this.preloadText.destroy(!0), this.playButton = null, this.background = null, this.preloadText = null, this.config = null, this.game.scale.onSizeChange.remove(this.resize, this), this.game.load.onLoadStart.remove(this.onPreloadStart, this), this.game.load.onFileComplete.remove(this.onPreloadedFile, this), this.game.load.onLoadComplete.remove(this.onPreloadEnd, this), this.game.state.remove(b.Preloader.Name), this.game.state.remove(b.SplashPreloader.Name), this.game.state.remove(this.name)
            }, d
        }(Phaser.State);
    ...
    ! function(a) {
        var b = function(a) {
            function b(b) {
                ...
                return c.graphic1 = c.create(0, 0, "kizi_atlas_new", "shine2 instance 10000"), c.graphic1.anchor.setTo(.5), c.graphic1.angle = 90, c.graphic2 = c.create(0, 0, "kizi_atlas_new", "shine2 instance 10000"), c.graphic2.anchor.setTo(.5), c.graphic3 = c.create(0, 0, "kizi_atlas_new", "shine1 instance 10000"), c.graphic3.anchor.setTo(.5), c
            }
            return __extends(b, a), b.prototype.start = function(a, b, c, d) {
                ...
                a.prototype.destroy.call(this), this.graphic1 = null, this.graphic2 = null, this.graphic3 = null
            }, b
        }(Phaser.Group);
        a.Shine = b
    }(b = a.SplashScreen || (a.SplashScreen = {}))
            ...
            function b(b, c, d, e, f, g, h) {
                ...
                return i.state = 0, i.counter = 0, i.skewX = 0, i.skewY = 0, i._srB = 0, i._srC = 0, i._crA = 1, i._crD = 1, i._cachedRotX = 0, i._cachedRotY = 0, i.onComplete = new Phaser.Signal, i.tweenDetails = new Array, i.floor = g, i.cell = h, i.updateTransform = function(a) {
                    ...
                    if (k % Phaser.Math.PI2 || l % Phaser.Math.PI2 ? (l === this._cachedRotX && k === this._cachedRotY || (this._cachedRotX = l, this._cachedRotY = k, this._crA = Math.cos(k), this._srB = Math.sin(k), this._srC = Math.sin(-l), this._crD = Math.cos(l)), c = this._crA * this.scale.x, d = this._srB * this.scale.x, e = this._srC * this.scale.y, f = this._crD * this.scale.y, g = this.position.x, h = this.position.y, (this.pivot.x || this.pivot.y) && (g -= this.pivot.x * c + this.pivot.y * e, h -= this.pivot.x * d + this.pivot.y * f), j.a = c * i.a + d * i.c, j.b = c * i.b + d * i.d, j.c = e * i.a + f * i.c, j.d = e * i.b + f * i.d, j.tx = g * i.a + h * i.c + i.tx, j.ty = g * i.b + h * i.d + i.ty) : (c = this.scale.x, f = this.scale.y, g = this.position.x - this.pivot.x * c, h = this.position.y - this.pivot.y * f, j.a = c * i.a, j.b = c * i.b, j.c = f * i.c, j.d = f * i.d, j.tx = g * i.a + h * i.c + i.tx, j.ty = g * i.b + h * i.d + i.ty), this.worldAlpha = this.alpha * b.worldAlpha, this.worldPosition.set(j.tx, j.ty), this.worldScale.set(this.scale.x * Math.sqrt(j.a * j.a + j.c * j.c), this.scale.y * Math.sqrt(j.b * j.b + j.d * j.d)), this.worldRotation = Math.atan2(-j.c, j.d), this._currentBounds = null, this.transformCallback && this.transformCallback.call(this.transformCallbackContext, j, i), !this._cacheAsBitmap) {
                        for (var m = 0; m < this.children.length; m++) this.children[m].updateTransform();
                        return this
                    }
                }, i
            }
            return __extends(b, a), b.prototype.show = function(a) {
                this.dir = a, this.setTween(1, 14, {
                    scaleX: 1
                })
                ...
                if (this.tweenDetails) {
                    ...
                    for (var f = 0, g = Object.keys(c); f < g.length; f++) {
                        var h = g[f];
                        d = this[h], e = c[h], d !== e && this.tweenDetails.push({
                            propertyName: h,
                            start: d,
                            change: e - d
                        })
                ...
                a.prototype.destroy.call(this), this.onComplete = null, this.tweenDetails = [], this.tweenDetails = null
            }, b
        }(Phaser.Sprite);
        a.SmallPart = b
    }(b = a.SplashScreen || (a.SplashScreen = {}))
    ...
    ! function(a) {
        var b = function(b) {
            function c() {
                ...
                return a.name = c.Name, a.scaleFactor = 1, a.width = 787, a.height = 494, a.created = !1, a.preloadTexts = [], a.preloadReady = !1, a.clicked = !1, a.tId = 0, a
            }
            return __extends(c, b), c.prototype.init = function(a, b) {
                ...
                this.spine = this.game.add.spine(this.game.width / 2, this.game.height / 2, "splash_playcell"), this.spine.setMixByName("intro", "loop", .2), this.spine.setMixByName("loop", "outro", .2), this.spine.setAnimationByName(0, "intro", !1), this.spine.addAnimationByName(0, "loop", !0, 0), this.logo = this.game.add.sprite(this.game.width / 2, .4 * this.game.height, "playcell_atlas", "logo"), this.logo.scale.set(this.scaleFactor), this.logo.anchor.set(.5), this.logo.visible = !1, this.playButton = this.game.add.image(this.game.width / 2, this.game.height, "playcell_atlas", "button"), this.playButton.anchor.set(.5), this.playButton.scale.set(this.scaleFactor), this.playButton.y = this.logo.y + .75 * this.logo.height, this.playButton.inputEnabled = !0, this.playButton.events.onInputUp.add(this.handler, this), this.playButton.visible = !1, this.created = !0
            }, c.prototype.resizeObjects = function() {
                this.created && (this.logo.position.set(this.game.width / 2, .4 * this.game.height), this.logo.scale.set(this.scaleFactor), this.playButton.x = this.game.width / 2, this.playButton.y = this.logo.y + .75 * this.logo.height)
                ...
                var a = this;
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.resizeObjects(), this.spine.setAnimationByName(0, "outro", !1), this.spine.onComplete.add(function() {
                    a.logo.visible = !0, a.playButton.visible = !0, a.buttonTween = a.game.add.tween(a.playButton.scale), a.buttonTween.to({
                        x: 1.14 * a.scaleFactor,
                        y: 1.14 * a.scaleFactor
                    }, 420, Phaser.Easing.Quadratic.InOut, !0, 500), a.buttonTween.yoyo(!0).onComplete.add(a.animateButton, a), a.buttonTween.start(), a.spine.visible = !1
                ...
                b.prototype.shutdown.call(this), this.playButton.destroy(!0), this.background.destroy(!0), this.spine.destroy(!0), this.playButton = null, this.logo = null, this.background = null, this.game.scale.onSizeChange.remove(this.resize, this), this.game.load.onLoadStart.remove(this.onPreloadStart, this), this.game.load.onFileComplete.remove(this.onPreloadedFile, this), this.game.load.onLoadComplete.remove(this.onPreloadEnd, this), this.game.state.remove(a.Preloader.Name), this.game.state.remove(a.SplashPreloader.Name), this.game.state.remove(this.name)
            }, c
        }(Phaser.State);
...
! function(a) {
    ...
    ! function(b) {
        var c = function(c) {
            function d() {
                var a = c.call(this) || this;
                return a.name = d.Name, a.scaleFactor = 1, a.created = !1, a.preloadReady = !1, a.clicked = !1, a.preloadTexts = ["Spelletje wordt geladen"], a.dotText = ".", a.tId = 0, a
            }
            return __extends(d, c), d.prototype.init = function(a, b) {
                this.config = a, this.background = b, this.config.preloadTexts && (this.preloadTexts = this.config.preloadTexts), this.game.scale.onSizeChange.add(this.resize, this)
            }, d.prototype.preload = function() {
                ...
                this.twirl = this.game.add.image(this.game.width / 2, this.game.height / 2, "spele_atlas", "spele_bg_pattern"), this.twirl.anchor.set(.5), this.twirl.width = this.twirl.height = this.game.width > this.game.height ? this.game.width : this.game.height, this.jelly = this.game.add.spine(0, 0, "jelly_skeleton"), this.jelly.setAnimationByName(0, "idle", !0), this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 + 230, "", {
                    ...
                    fill: "#ffffff",
                    fontWeight: "bold"
                }), this.preloadText.anchor.set(.5), this.logo = this.game.add.image(0, 0, "spele_atlas", "spele_logo"), this.logo.anchor.set(.5), d.IdealWidth = 1.5 * this.logo.getBounds().width;
                var a = "spele_button";
    ...
    ! function(b) {
        var c = function(c) {
            ...
            return __extends(d, c), d.prototype.init = function(a, b) {
                ...
                this.created && (this.logo.scale.set(this.scaleFactor), this.logo.y = this.game.height / 2, this.logo.x = this.game.width / 2, a.Utils.isOnDevice(this.game) || (this.playButton.x = this.game.width / 2, this.playButton.y = .75 * this.game.height))
            }, d.prototype.handler = function(a, b) {
                if (!this.clicked && "mouseout" !== b.type) {
                    this.clicked = !0, this.game.tweens.remove(this.buttonTween), this.game.camera.fade(0, 250);
                    var c = this.game.add.tween(this.playButton.scale);
    ...
    ! function(a) {
        var b = function(b) {
            ...
            return __extends(c, b), c.prototype.init = function(a, b) {
                ...
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.spine.visible = !0, this.spine.setAnimationByName(0, "flyin", !1), this.spine.addAnimationByName(0, "idle", !0, 0), this.game.tweens.removeAll(), this.balls.forEach(function(a) {
...
! function(a) {
    var b = function() {
        ...
        return b.getSourceSite = function(c) {
            ...
            if (c && (d = window.location.host), d.indexOf("embed.gamedistribution.com") !== -1 && window.location.search.indexOf("gd_sdk_referrer_url") !== -1 && (d = b.getUrlParameter("gd_sdk_referrer_url") || d),
                d = decodeURIComponent(d), a.Branding.isBild()) return "bildspielt.de";
    ...
    b.ASSET_LOCATION = "https://cdn.fbrq.io/@orange-games/splash/assets/", a.Utils = b
}(Fabrique || (Fabrique = {}));
...
! function(a) {
    ...
    }(a.Platform || (a.Platform = {})), a.Platform,
        function(a) {
    ...
    var c = function() {
        ...
        return b.prototype.init = function(c, d, e, f) {
            ...
            return this.sendEvent(h.toString(), "init", function(a) {
                g.initProcessed = !0, !0 === a.enabled && (g.enabled = !0, g.timeOffset = (Date.now() / 1e3 | 0) - a.server_ts)
            ...
            if (!(c.length < 1)) {
                ...
                a.Utils.postRequest(h, c, g, function(a) {
                    if (!1 === a.success && window.console && console.log(a.message), null != e) {
                        var b = "";
                        try {
    ...
    ! function(a) {
        var b = function() {
            ...
            return a.getItem = function(b) {
                if (a.Available) return localStorage.getItem(a.CacheKey + b)
    ...
    ! function(b) {
        var c = function() {
            ...
            return Object.defineProperty(b.prototype, "data", {
                get: function() {
                    for (var b in this.event) this.event.hasOwnProperty(b) && (this.annotations[b] = "category" === b ? a.Events.Category[this.event[b]] : this.event[b]);
