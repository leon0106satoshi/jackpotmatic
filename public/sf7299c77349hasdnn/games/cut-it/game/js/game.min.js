...
LevelButton.prototype = Object.create(Phaser.Button.prototype), LevelButton.prototype.goToLevel = function() {
    ...
    preload: function() {
        this.cm_logo = game.add.image(210, 150, "circusmoth"), this.cm_logo.anchor.setTo(.5, .5), this.preload_bg = game.add.image(57, 250, "loading_bar_0"), this.preload_bar = game.add.image(57, 250, "loading_bar_1"), this.loading = game.add.image(210, 330, "loading"), this.loading.anchor.setTo(.5, .5), game.add.tween(this.loading.scale).to({
            x: 1.2,
            y: 1.2
        }, 1e3, Phaser.Easing.Sinusoidal.InOut, !0, 0, -1, !0), this.load.setPreloadSprite(this.preload_bar), game.load.bitmapFont("font_label", "assets/images/font_label.png", "assets/images/font_label.fnt", null, 0), game.load.bitmapFont("font_digits", "assets/images/font-digits.png", "assets/images/font-digits.fnt", null, 4), game.load.atlasJSONHash("ssheet", ("assets/images/spritesheet.png"), "assets/images/spritesheet.json"), game.load.atlasJSONHash("lvlmini", "assets/images/lvlmini.png", "assets/images/lvlmini.json"), game.load.image("line_dbg", "assets/images/line_dbg.png"), game.load.audio("music_sfx", "assets/sounds/music.ogg"), game.load.audio("chainsaw_sfx", "assets/sounds/chainsaw_1s.ogg"), game.load.audio("chainsaw_alt_sfx", "assets/sounds/chainsaw_1s_alt.ogg"), game.load.audio("click_sfx", "assets/sounds/click.ogg"), game.load.audio("transition_sfx", "assets/sounds/transition.ogg"), game.load.audio("whoosh_sfx", "assets/sounds/whoosh.ogg"), game.load.audio("label_pop_sfx", "assets/sounds/label_pop.ogg"), game.load.audio("win_sfx", "assets/sounds/win.ogg"), game.load.audio("lose_sfx", "assets/sounds/lose.ogg")
    },
    create: function() {
...
TurnDevice.prototype = Object.create(Phaser.Group.prototype), TurnDevice.prototype.constructor = TurnDevice, TurnDevice.prototype.show = function() {
    ...
    game.scale.isLandscape ? this.show() : this.hide()
...
SaveLoad = {}, SaveLoad.loadSave = function() {
    ...
    try {
        this.level = window.famobi.localStorage.getItem("cutit_level")
    } catch (t) {
    ...
    try {
        this.SFX = window.famobi.localStorage.getItem("SFX")
    } catch (t) {
    ...
    try {
        window.famobi.localStorage.setItem("SFX", this.SFX)
    } catch (t) {
    ...
    if (this.level[t][e] < s) {
        ...
        try {
            window.famobi.localStorage.setItem("cutit_level", JSON.stringify(this.level))
        } catch (a) {
            console.log("CAN'T ACCESS localStorage")
        }
        return !0
    ...
    reallyEndProcedure: function() {
        this.makeLabels(), game.add.tween(this.wood).to({
            y: this.wood.y - 10
