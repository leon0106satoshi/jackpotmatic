...
function CMovesControllerFaster(aMatrix) {
        ...
        for (var i = 0; i < aCurPlayerPieces.length; i++) {
            ...
            for (var j = 0; j < aCurPieceMoveList.length; j++) {
                ...
                var oMove = {
                    ...
                    sourcecol: iSourceCol,
                    destrow: iDestRow,
                    destcol: iDestCol,
                    sourcetype: aBoard[iSourceRow][iSourceCol].type,
                    sourcecolor: aBoard[iSourceRow][iSourceCol].color,
                    sourcehistory: aBoard[iSourceRow][iSourceCol].history,
                    desttype: aBoard[iDestRow][iDestCol].type,
                    destcolor: aBoard[iDestRow][iDestCol].color,
                    desthistory: aBoard[iDestRow][iDestCol].history
                };
    ...
    this._makeMove = function(aBoard, oMove) {
        ...
        aBoard[oMove.destrow][oMove.destcol] = {
            color: oMove.sourcecolor,
            type: oMove.sourcetype,
            history: oMove.sourcehistory
        };
        aBoard[oMove.sourcerow][oMove.sourcecol] = {
            color: null,
            type: null,
            history: []
        };
    ...
    this._unMakeMove = function(aBoard, oMove) {
        ...
        aBoard[oMove.destrow][oMove.destcol] = {
            color: oMove.destcolor,
            type: oMove.desttype,
            history: oMove.desthistory
        };
    };
    ...
    this.findAllChecks = function(szPlayerColor, aBoard) {
        ...
        for (var i = 0; i < aOpponentPieces.length; i++) {
            ...
            aMoves[i] = {
                list: s_oMovesControllerFaster.getMovesList(oLogicPos.row, oLogicPos.col, aBoard),
                piece: aOpponentPieces[i]
            };
        }
