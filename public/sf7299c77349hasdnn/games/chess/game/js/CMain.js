function CMain(oData) {
    ...
    this._loadImages = function() {
        ...
        s_oSpriteLibrary.addSprite("but_lang_ENG", "./sprites/language_button_ENG.png");
        s_oSpriteLibrary.addSprite("but_lang_RUS", "./sprites/language_button_RUS.png");
        s_oSpriteLibrary.addSprite("but_lang_GER", "./sprites/language_button_GER.png");
        s_oSpriteLibrary.addSprite("but_lang_ARAB", "./sprites/language_button_ARAB.png");
        ...
        s_oSpriteLibrary.addSprite("but_lang_POR", "./sprites/language_button_POR.png");
        s_oSpriteLibrary.addSprite("but_lang_SP", "./sprites/language_button_SP.png");
        // languages -------------------------------------------------------------------------------------
