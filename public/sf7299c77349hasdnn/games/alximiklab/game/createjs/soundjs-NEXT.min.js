...
this.createjs = this.createjs || {},
    function() {
        ...
        a.version = "NEXT", a.buildDate = "Mon, 21 Apr 2014 15:30:09 GMT"
    }(), this.createjs = this.createjs || {},
    function() {
        "use strict";
        var a = function() {},
    ...
    function() {
        ...
        e.INTERRUPT_ANY = "any", e.INTERRUPT_EARLY = "early", e.INTERRUPT_LATE = "late", e.INTERRUPT_NONE = "none", e.PLAY_INITED = "playInited", e.PLAY_SUCCEEDED = "playSucceeded", e.PLAY_INTERRUPTED = "playInterrupted", e.PLAY_FINISHED = "playFinished", e.PLAY_FAILED = "playFailed", e.SUPPORTED_EXTENSIONS = ["mp3", "ogg", "mpeg", "wav", "m4a", "mp4", "aiff", "wma", "mid"], e.EXTENSION_MAP = {
            ...
            if (e._preloadHash[a])
                for (var b = 0, c = e._preloadHash[a].length; c > b; b++) {
                    ...
                    if (e._preloadHash[a][b] = !0, e.hasEventListener("fileload")) {
                        ...
                        f.src = d.src, f.id = d.id, f.data = d.data, f.sprite = d.sprite, e.dispatchEvent(f)
                    }
                }
            ...
            return a.isSupported() ? (e.activePlugin = new a, !0) : !1
        }, e.registerPlugins = function(a) {
            e._pluginsRegistered = !0;
            for (var b = 0, c = a.length; c > b; b++)
                if (e._registerPlugin(a[b])) return !0;
            return !1
            ...
            var f = e._parsePath(a);
            if (null == f) return !1;
            f.type = "sound", f.id = c, f.data = d;
            var g = e.activePlugin.defaultNumChannels || null;
            if (null != d && (isNaN(d.channels) ? isNaN(d) || (g = parseInt(d)) : g = parseInt(d.channels), d.audioSprite))
                for (var h, i = d.audioSprite.length; i--;) h = d.audioSprite[i], e._idHash[h.id] = {
                    src: f.src,
            ...
            var j = e.activePlugin.register(f.src, g);
            return b.create(f.src, g), null != d && isNaN(d) ? f.data.channels = g || b.maxPerChannel() : f.data = g || b.maxPerChannel(), f.tag = j.tag, j.completeHandler && (f.completeHandler = j.completeHandler), j.type && (f.type = j.type), f
        }, e.registerSound = function(a, b, c, d) {
            a instanceof Object && (d = b, b = a.id, c = a.data, a = a.src), null != d && (a = d + a);
            var f = e._registerSound(a, b, c);
            if (!f) return !1;
            if (e._preloadHash[f.src] || (e._preloadHash[f.src] = []), e._preloadHash[f.src].push({
                    src: a,
                    id: b,
                    data: f.data
                }), 1 == e._preloadHash[f.src].length) e.activePlugin.preload(f.src, f.tag);
            else if (1 == e._preloadHash[f.src][0]) return !0;
            return f
        }, e.registerManifest = function(a, b) {
            for (var c = [], d = 0, e = a.length; e > d; d++) c[d] = createjs.Sound.registerSound(a[d].src, a[d].id, a[d].data, b);
            return c
        }, e.removeSound = function(a, c) {
            if (null == e.activePlugin) return !1;
            a instanceof Object && (a = a.src), a = e._getSrcById(a).src, null != c && (a = c + a);
            var d = e._parsePath(a);
            if (null == d) return !1;
            a = d.src;
            for (var f in e._idHash) e._idHash[f].src == a && delete e._idHash[f];
            ...
            e._idHash = {}, e._preloadHash = {}, b.removeAll(), e.activePlugin && e.activePlugin.removeAllSounds()
        }, e.loadComplete = function(a) {
            var b = e._parsePath(a);
            return a = b ? e._getSrcById(b.src).src : e._getSrcById(a).src, 1 == e._preloadHash[a][0]
        }, e._parsePath = function(a) {
            "string" != typeof a && (a = a.toString());
            var b = a.match(e.FILE_PATTERN);
            if (null == b) return !1;
            for (var c = b[4], d = b[5], f = e.getCapabilities(), g = 0; !f[d];)
                if (d = e.alternateExtensions[g++], g > e.alternateExtensions.length) return null;
            a = a.replace("." + b[5], "." + d);
            var h = {
                name: c,
                src: a,
            ...
            return h
        }, e.play = function(a, b, c, d, f, g, h, i, j) {
            b instanceof Object && (c = b.delay, d = b.offset, f = b.loop, g = b.volume, h = b.pan, i = b.startTime, j = b.duration, b = b.interrupt);
            var k = e.createInstance(a, i, j),
                l = e._playInstance(k, b, c, d, f, g, h);
            return l || k.playFailed(), k
        }, e.createInstance = function(c, d, f) {
            if (!e.initializeDefaultPlugins()) return e._defaultSoundInstance;
            c = e._getSrcById(c);
            var g = e._parsePath(c.src),
                h = null;
            return null != g && null != g.src ? (b.create(g.src), null == d && (d = c.startTime), h = e.activePlugin.create(g.src, d, f || c.duration)) : h = a._defaultSoundInstance, h.uniqueId = e._lastID++, h
    ...
    function() {
        ...
        c._capabilities = null, c._volume = 1, c.context = null, c._panningModel = "equalpower", c.dynamicsCompressorNode = null, c.gainNode = null, c._arrayBuffers = null, c._init = function() {
            ...
            createjs.Sound._sendFileLoadEvent(a.src), a.cleanUp()
            ...
            return this.isPreloadStarted(a) || this.preload(a), new createjs.WebAudioPlugin.SoundInstance(a, b, c, this)
    ...
    function() {
        ...
        b.src = null, b.uniqueId = -1, b.playState = null, b._owner = null, b._offset = 0, b._startTime = 0, b._volume = 1, createjs.definePropertySupported && Object.defineProperty(b, "volume", {
            get: function() {
                return this._volume
            },
            set: function(a) {
        ...
        }), b._pan = 0, createjs.definePropertySupported && Object.defineProperty(b, "pan", {
            get: function() {
                return this._pan
            },
            set: function(a) {
        ...
        }), b._duration = 0, b._remainingLoops = 0, b._delayTimeoutId = null, b._soundCompleteTimeout = null, b.gainNode = null, b.panNode = null, b.sourceNode = null, b._sourceNodeNext = null, b._muted = !1, b.paused = !1, b._paused = !1, b._playbackStartTime = 0, b._endedHandler = null, b._sendEvent = function(a) {
            ...
            if (this._duration || (this._duration = 1e3 * this._owner._arrayBuffers[this.src].duration), 1e3 * this._offset > this._duration) return this.playFailed(), void 0;
            ...
            c.buffer = this._owner._arrayBuffers[this.src], c.connect(this.panNode);
            var d = .001 * this._duration;
            return c.startTime = a + d, c.start(c.startTime, b + this._startTime, d - b), c
        }, b.play = function(a, b, c, d, e, f) {
            this._cleanUp(), createjs.Sound._playInstance(this, a, b, c, d, e, f)
        }, b._beginPlaying = function(a, b, c, d) {
            return this._offset = .001 * a, this._remainingLoops = b, this.volume = c, this.pan = d, this._owner.isPreloadComplete(this.src) ? (this._handleSoundReady(null), this._sendEvent("succeeded"), 1) : (this.playFailed(), void 0)
        }, b.pause = function() {
            ...
            return null == a ? !1 : (this._muted = a, this._updateVolume(), !0)
        }, b.getMute = function() {
            return this._muted
        }, b.setPan = function(a) {
            return this.pan = a, this.pan != a ? !1 : !0
        }, b.getPan = function() {
            return this.pan
        }, b.getPosition = function() {
            if (this._paused || null == this.sourceNode) var a = this._offset;
            else var a = this._owner.context.currentTime - this._playbackStartTime;
            return 1e3 * a
        }, b.setPosition = function(a) {
            return this._offset = .001 * a, this.sourceNode && this.playState == createjs.Sound.PLAY_SUCCEEDED && (this.sourceNode = this._cleanUpAudioNode(this.sourceNode), this._sourceNodeNext = this._cleanUpAudioNode(this._sourceNodeNext), clearTimeout(this._soundCompleteTimeout)), this._paused || this.playState != createjs.Sound.PLAY_SUCCEEDED || this._handleSoundReady(), !0
    ...
    function() {
        ...
        var b = a.prototype;
        b.request = null, b.owner = null, b.progress = -1, b.src = null, b.result = null, b.onload = null, b.onprogress = null, b.onerror = null, b._init = function(a, b) {
            this.src = a, this.owner = b
        }, b.load = function(a) {
            ...
            this.progress = a / b, this.onprogress && this.onprogress({
                loaded: a,
                total: b,
            ...
            this.progress = 1, this.result = a, this.owner.addPreloadResults(this.src, this.result), this.onload && this.onload(this)
    ...
    function() {
        ...
        var b = a;
        b.MAX_INSTANCES = 30, b._AUDIO_READY = "canplaythrough", b._AUDIO_ENDED = "ended", b._AUDIO_SEEKED = "seeked", b._AUDIO_STALLED = "stalled", b._TIME_UPDATE = "timeupdate", b._capabilities = null, b.enableIOS = !1, b.isSupported = function() {
            return createjs.Sound.BrowserDetect.isIOS && !b.enableIOS ? !1 : (b._generateCapabilities(), null == b._capabilities ? !1 : !0)
        }, b._generateCapabilities = function() {
            if (null == b._capabilities) {
                var a = document.createElement("audio");
                if (null == a.canPlayType) return null;
        ...
        var c = a.prototype;
        c._capabilities = null, c._audioSources = null, c.defaultNumChannels = 2, c._init = function() {
            this._capabilities = b._capabilities, this._audioSources = {}
        }, c.register = function(a, b) {
            this._audioSources[a] = !0;
            for (var c = createjs.HTMLAudioPlugin.TagPool.get(a), d = null, e = b, f = 0; e > f; f++) d = this._createTag(a), c.add(d);
            return {
                tag: d
            }
            ...
            if (!this.isPreloadStarted(a)) {
                var d = createjs.HTMLAudioPlugin.TagPool.get(a),
                    e = this._createTag(a);
                e.id = a, d.add(e), this.preload(a, {
                    tag: e
                })
            }
            return new createjs.HTMLAudioPlugin.SoundInstance(a, b, c, this)
        }, c.isPreloadStarted = function(a) {
            return null != this._audioSources[a]
        }, c.preload = function(a, b) {
            this._audioSources[a] = !0, new createjs.HTMLAudioPlugin.Loader(a, b)
        }, c.toString = function() {
    ...
    function() {
        ...
        var b = a.prototype = new createjs.EventDispatcher;
        b.src = null, b.uniqueId = -1, b.playState = null, b._owner = null, b.loaded = !1, b._offset = 0, b._startTime = 0, b._volume = 1, createjs.definePropertySupported && Object.defineProperty(b, "volume", {
            get: function() {
                return this._volume
            },
            set: function(a) {
        ...
        }), b.pan = 0, b._duration = 0, b._audioSpriteStopTime = null, b._remainingLoops = 0, b._delayTimeoutId = null, b.tag = null, b._muted = !1, b.paused = !1, b._paused = !1, b._endedHandler = null, b._readyHandler = null, b._stalledHandler = null, b._audioSpriteEndHandler = null, b.loopHandler = null, b._init = function(a, b, c, d) {
            ...
            var a = this.tag;
            if (null != a) {
                a.pause(), this.tag.loop = !1, a.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_ENDED, this._endedHandler, !1), a.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_READY, this._readyHandler, !1), a.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_SEEKED, this.loopHandler, !1), a.removeEventListener(createjs.HTMLAudioPlugin._TIME_UPDATE, this.__audioSpriteEndHandler, !1);
                try {
            ...
            this._cleanUp(), createjs.Sound._playInstance(this, a, b, c, d, e, f)
        }, b._beginPlaying = function(a, b, c) {
            var d = this.tag = createjs.HTMLAudioPlugin.TagPool.getInstance(this.src);
            return null == d ? (this.playFailed(), -1) : (d.addEventListener(createjs.HTMLAudioPlugin._AUDIO_ENDED, this._endedHandler, !1), this._offset = a, this.volume = c, this._updateVolume(), this._remainingLoops = b, 4 !== d.readyState ? (d.addEventListener(createjs.HTMLAudioPlugin._AUDIO_READY, this._readyHandler, !1), d.addEventListener(createjs.HTMLAudioPlugin._AUDIO_STALLED, this._stalledHandler, !1), d.preload = "auto", d.load()) : this._handleSoundReady(null), this._sendEvent("succeeded"), 1)
        }, b._handleSoundStalled = function() {
            this._cleanUp(), this._sendEvent("failed")
        }, b._handleSoundReady = function() {
            return this.playState = createjs.Sound.PLAY_SUCCEEDED, this.paused = this._paused = !1, this.tag.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_READY, this._readyHandler, !1), this.tag.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_SEEKED, this.loopHandler, !1), this._offset >= this.getDuration() ? (this.playFailed(), void 0) : (this.tag.currentTime = .001 * (this._startTime + this._offset), this._audioSpriteStopTime ? (this.tag.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_ENDED, this._endedHandler, !1), this.tag.addEventListener(createjs.HTMLAudioPlugin._TIME_UPDATE, this.__audioSpriteEndHandler, !1)) : -1 == this._remainingLoops ? this.tag.loop = !0 : 0 != this._remainingLoops && (this.tag.addEventListener(createjs.HTMLAudioPlugin._AUDIO_SEEKED, this.loopHandler, !1), this.tag.loop = !0), this.tag.play(), void 0)
        }, b.pause = function() {
            ...
            if (null == this.tag) this._offset = a;
                ...
                try {
                    a += this._startTime, this.tag.currentTime = .001 * a
                } catch (b) {
                    return !1
                }
    ...
    function() {
        ...
        b.tags = {}, b.get = function(c) {
            ...
            var c = b.tags[a];
            return null == c ? 0 : c.getDuration()
        };
        var c = a.prototype;
        c.src = null, c.length = 0, c.available = 0, c.tags = null, c.duration = 0, c._init = function(a) {
