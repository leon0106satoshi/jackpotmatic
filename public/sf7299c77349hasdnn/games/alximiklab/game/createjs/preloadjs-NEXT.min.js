...
this.createjs = this.createjs || {},
    function() {
        ...
        a.version = "NEXT", a.buildDate = "Wed, 02 Apr 2014 17:54:19 GMT"
    }(), this.createjs = this.createjs || {},
    function() {
        "use strict";
    ...
    function() {
        ...
        var b = a.prototype,
            c = a;
        c.ABSOLUTE_PATT = /^(?:\w+:)?\/{2}/i, c.RELATIVE_PATT = /^[./]*?\//i, c.EXTENSION_PATT = /\/?[^/]+\.(\w{1,5})$/i, b.loaded = !1, b.canceled = !1, b.progress = 0, b._item = null, b.getItem = function() {
            return this._item
            ...
            d > -1 && (a = a.substr(0, d));
            var e;
            return c.ABSOLUTE_PATT.test(a) ? b.absolute = !0 : c.RELATIVE_PATT.test(a) && (b.relative = !0), (e = a.match(c.EXTENSION_PATT)) && (b.extension = e[1].toLowerCase()), b
    ...
    function() {
        ...
        c.loadTimeout = 8e3, c.LOAD_TIMEOUT = 0, c.BINARY = "binary", c.CSS = "css", c.IMAGE = "image", c.JAVASCRIPT = "javascript", c.JSON = "json", c.JSONP = "jsonp", c.MANIFEST = "manifest", c.SOUND = "sound", c.SVG = "svg", c.TEXT = "text", c.XML = "xml", c.POST = "POST", c.GET = "GET", b._basePath = null, b._crossOrigin = "", b.useXHR = !0, b.stopOnError = !1, b.maintainScriptOrder = !0, b.next = null, b._typeCallbacks = null, b._extensionCallbacks = null, b._loadStartWasDispatched = !1, b._maxConnections = 1, b._currentlyLoadingScript = null, b._currentLoads = null, b._loadQueue = null, b._loadQueueBackup = null, b._loadItemsById = null, b._loadItemsBySrc = null, b._loadedResults = null, b._loadedRawResults = null, b._numItems = 0, b._numItemsLoaded = 0, b._scriptOrder = null, b._loadedScripts = null, b.init = function(a, b, c) {
            ...
            e.extension && (d.ext = e.extension), null == d.type && (d.type = this._getTypeByExtension(d.ext));
            var f = "",
                g = c || this._basePath,
                h = d.src;
            if (!e.absolute && !e.relative)
                if (b) {
                    f = b;
                    var i = this._parseURI(b);
                    h = b + h, null == g || i.absolute || i.relative || (f = g + f)
                } else null != g && (f = g);
            ...
            if (j) {
                ...
                if (k === !1) return null;
                k === !0 || (null != k.src && (d.src = k.src), null != k.id && (d.id = k.id), null != k.tag && (d.tag = k.tag), null != k.completeHandler && (d.completeHandler = k.completeHandler), k.type && (d.type = k.type), e = this._parseURI(d.src), null != e.extension && (d.ext = e.extension))
            }
            ...
            if (this.maintainScriptOrder && c.type == createjs.LoadQueue.JAVASCRIPT || c.maintainOrder) {
                a instanceof createjs.TagLoader && c.type == createjs.LoadQueue.JAVASCRIPT && (this._currentlyLoadingScript = !1);
            ...
            if (a.type == createjs.LoadQueue.MANIFEST) {
                var c = b.getResult();
            ...
            if (!this.maintainScriptOrder || a instanceof createjs.XHRLoader) return !0;
            var b = a.getItem();
            ...
            var b = a.getItem();
            delete b._loader, delete b._loadAsJSONP;
    ...
    function() {
        ...
        b._loadTimeout = null, b._tagCompleteProxy = null, b._isAudio = !1, b._tag = null, b._jsonResult = null, b.init = function(a) {
            ...
            if (a.type == createjs.LoadQueue.SVG || a.type == createjs.LoadQueue.JSONP || a.type == createjs.LoadQueue.JSON || a.type == createjs.LoadQueue.MANIFEST || a.type == createjs.LoadQueue.JAVASCRIPT || a.type == createjs.LoadQueue.CSS) {
                this._startTagVisibility = b.style.visibility, b.style.visibility = "hidden";
                var e = document.body || document.getElementsByTagName("body")[0];
                if (null == e) {
                    if (a.type == createjs.LoadQueue.SVG) return this._handleSVGError(), void 0;
                    e = document.head || document.getElementsByTagName("head")
                }
                e.appendChild(b)
            }
            null != b.load && b.load()
        }, b._handleSVGError = function() {
            this._clean();
            var a = new createjs.Event("error");
            a.text = "SVG_NO_BODY", this._sendError(a)
            ...
            if (!this._isCanceled()) {
                ...
                if (!(this.loaded || this._isAudio && 4 !== b.readyState)) {
                    switch (this.loaded = !0, a.type) {
                        ...
                        case createjs.LoadQueue.MANIFEST:
                        case createjs.LoadQueue.CSS:
                            b.style.visibility = this._startTagVisibility, b.parentNode && b.parentNode.contains(b) && b.parentNode.removeChild(b)
                    }
    ...
    function() {
        ...
        var a = function(a, b) {
            ...
            b = a;
        b.ACTIVEX_VERSIONS = ["Msxml2.XMLHTTP.6.0", "Msxml2.XMLHTTP.5.0", "Msxml2.XMLHTTP.4.0", "MSXML2.XMLHTTP.3.0", "MSXML2.XMLHTTP", "Microsoft.XMLHTTP"];
        var c = a.prototype = new createjs.AbstractLoader;
        c._request = null, c._loadTimeout = null, c._xhrLevel = 1, c._response = null, c._rawResponse = null, c._crossOrigin = "", c.init = function(a, b) {
            ...
            var c = this._isCrossDomain(a),
                d = {},
                e = null;
            if (window.XMLHttpRequest) e = new XMLHttpRequest, c && void 0 === e.withCredentials && window.XDomainRequest && (e = new XDomainRequest);
            else {
                for (var f = 0, g = b.ACTIVEX_VERSIONS.length; g > f; f++) {
                    b.ACTIVEX_VERSIONS[f];
                    try {
                        e = new ActiveXObject(axVersions);
                        break
                    } catch (h) {}
                }
                if (null == e) return !1
            }
            createjs.LoadQueue.isText(a.type) && e.overrideMimeType && e.overrideMimeType("text/plain; charset=utf-8"), this._xhrLevel = "string" == typeof e.responseType ? 2 : 1;
            var i = null;
            if (i = a.method == createjs.LoadQueue.GET ? this.buildPath(a.src, a.values) : a.src, e.open(a.method || createjs.LoadQueue.GET, i, !0), c && e instanceof XMLHttpRequest && 1 == this._xhrLevel && (d.Origin = location.origin), a.values && a.method == createjs.LoadQueue.POST && (d["Content-Type"] = "application/x-www-form-urlencoded"), c || d["X-Requested-With"] || (d["X-Requested-With"] = "XMLHttpRequest"), a.headers)
                for (var j in a.headers) d[j] = a.headers[j];
            createjs.LoadQueue.isBinary(a.type) && (e.responseType = "arraybuffer");
            for (j in d) e.setRequestHeader(j, d[j]);
            return this._request = e, !0
        }, c._clean = function() {
            clearTimeout(this._loadTimeout);
            var a = this._request;
            ...
            a && (a.onload = null), this._sendComplete()
        }, c.toString = function() {
