function CAnimation() {
    ...
    this.drawFourAnim = function() {
        ...
        new createjs.Tween.get(_oDrawFour).to({
            alpha: 1,
            scaleX: 1.4,
            scaleY: 1.4
        }, 200, createjs.Ease.cubicOut).wait(200).call(function() {
            _oDrawFour.gotoAndPlay("anim");
        }).wait(1000).call(function() {
            _oDrawFour.gotoAndPlay("reverse");
        }).wait(200).to({
            alpha: 0,
            scaleX: 0.01,
            scaleY: 0.01
        }, 200, createjs.Ease.cubicIn).call(function() {
            s_oStage.removeChild(_oDrawFour);
    ...
    this.drawTwoAnim = function() {
        ...
        _oDrawTwo.stop();
        _oSpecialCardSound = playSound("special_card", 0.5, false);
        new createjs.Tween.get(_oDrawTwo).to({
            alpha: 1,
            scaleX: 1.4,
            scaleY: 1.4
        }, 200, createjs.Ease.cubicOut).wait(200).call(function() {
            _oDrawTwo.gotoAndPlay("anim");
            setVolume("special_card", 0.2);
        }).wait(1000).call(function() {
            _oDrawTwo.gotoAndPlay("reverse");
            ...
            s_oStage.removeChild(_oDrawTwo);
    ...
    this.stopTurn = function() {
        ...
        new createjs.Tween.get(_oStopTurn).to({
            alpha: 1,
            scaleX: 2,
            scaleY: 2
            ...
            s_oStage.removeChild(_oStopTurn);
            s_oGame.onNextTurn();
        });
    };
    this.changeClockWise = function(bClockWise) {
        ...
        _oSpecialCardSound = playSound("special_card", 0.5, false);
        if (bClockWise === false) {
            new createjs.Tween.get(_oChangeClockWise).to({
                alpha: 1,
                scaleX: 2,
                scaleY: 2
            }, 200, createjs.Ease.cubicOut).to({
                ...
                s_oStage.removeChild(_oChangeClockWise);
                s_oGame.onNextTurn();
            });;
        } else {
            new createjs.Tween.get(_oChangeClockWise).to({
    ...
    this.changeColor = function(iColor) {
        ...
        new createjs.Tween.get(_oChangeColor).to({
            alpha: 1,
            scaleX: 1.4,
            scaleY: 1.4
    ...
    this.endAnimation = function() {
        if (_bColor === true) {
            ...
            new createjs.Tween.get(_oChangeColor).to({
                ...
                s_oStage.removeChild(_oChangeColor);
                _oChangeColor.gotoAndStop(0);
                s_oInterface.refreshColor(_iCurrentColor);
                s_oGame.onNextTurn();
            });
        }
    };
    this.shuffleAnimation = function(iIndexPlayer, iNumberOfCards, iDelay, bPenality) {
        ...
        _oShuffleAnim.stop();
        new createjs.Tween.get(_oShuffleAnim).to({
            alpha: 1,
            scaleX: 1.6,
            scaleY: 1.6
