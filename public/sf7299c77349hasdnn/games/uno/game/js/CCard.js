function CCard(iX, iY, oParentContainer, szFotogram, iRank, iSuit) {
    ...
    this.moveCard = function(iX, iY, iTime, iDelay) {
        var oParent = this;
        createjs.Tween.get(_oContainer).wait(iDelay).to({
            x: iX,
            y: iY
        }, iTime, createjs.Ease.linear).call(function() {
