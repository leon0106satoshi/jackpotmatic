function CSelectPlayers() {
    ...
    this._init = function() {
        ...
        _pStartPosButP2 = {
            x: (oSpriteP2.height / 2) - 10,
            y: (oSpriteP2.height / 2)
        };
        ...
        _pStartPosButP3 = {
            x: (oSpriteP3.height / 2) - 10,
            y: (oSpriteP3.height / 2)
        };
        ...
        _pStartPosButP4 = {
            x: (oSpriteP4.height / 2) - 10,
            y: (oSpriteP4.height / 2)
        };
        ...
        var oSelectPlayerText = new CTLText(s_oStage, CANVAS_WIDTH / 2 - 500, 300, 1000, 150, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_SELECT_PLAYERS, true, true, true, false);
