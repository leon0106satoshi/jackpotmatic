    ...
    this.loadPage = function(iPage) {
        ...
        switch (iPage) {
            case 0:
                ...
                oText = new CTLText(_oContainerPage, -80, -120, 300, 240, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_TUTORIAL1, true, true, true, false);
            ...
            case 1:
                ...
                oText = new CTLText(_oContainerPage, -80, -120, 300, 240, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_TUTORIAL2, true, true, true, false);
                oExampleCard = new CCard(-215, 0, _oContainerPage, "card_0_12", 0, 0);
                oExampleCard.setAnimTutorial("draw2tutorial");
                break;
            case 2:
                oText = new CTLText(_oContainerPage, -80, -105, 300, 210, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_TUTORIAL3, true, true, true, false);
                oExampleCard = new CCard(-215, 0, _oContainerPage, "card_1_7", 0, 0);
                oExampleCard.setAnimTutorial("stopTurnTutorial");
                break;
            case 3:
                oText = new CTLText(_oContainerPage, -80, -105, 300, 210, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_TUTORIAL4, true, true, true, false);
                oExampleCard = new CCard(-215, 0, _oContainerPage, "card_1_7", 0, 0);
                oExampleCard.setAnimTutorial("changeClockWiseTutorial");
                break;
            case 4:
                oText = new CTLText(_oContainerPage, -80, -120, 300, 240, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_TUTORIAL5, true, true, true, false);
                oExampleCard = new CCard(-215, 0, _oContainerPage, "color", 0, 0);
                oExampleCard.instantShow();
                break;
            case 5:
                _oButNext.setVisible(true);
                oText = new CTLText(_oContainerPage, -80, -120, 300, 240, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_TUTORIAL6, true, true, true, false);
                oExampleCard = new CCard(-215, 0, _oContainerPage, "draw_four", 0, 0);
                oExampleCard.instantShow();
                break;
            case 6:
                _oButNext.setVisible(false);
                oText = new CTLText(_oContainerPage, -80, -120, 300, 240, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_TUTORIAL7, true, true, true, false);
