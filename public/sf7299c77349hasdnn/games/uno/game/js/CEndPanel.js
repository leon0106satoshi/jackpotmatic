function CEndPanel(oSpriteBg) {
    ...
    this._init = function(oSpriteBg) {
        ...
        _oMsgText = new CTLText(_oGroup, CANVAS_WIDTH / 2 - 250, (CANVAS_HEIGHT / 2) - 130, 500, 150, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, " ", true, true, true, false);
        _oScoreText = new CTLText(_oGroup, CANVAS_WIDTH / 2 - 250, (CANVAS_HEIGHT / 2) + 30, 500, 50, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, " ", true, true, false, false);
