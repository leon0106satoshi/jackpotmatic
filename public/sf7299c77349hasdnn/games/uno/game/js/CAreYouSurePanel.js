function CAreYouSurePanel(oFunction) {
    ...
    this._init = function(oFunction) {
        ...
        var oTitleStroke = new CTLText(_oPanelContainer, -250, -130, 500, 150, 50, "center", "#000000", PRIMARY_FONT, 1, 0, 0, TEXT_ARE_SURE, true, true, true, false);
        oTitleStroke.setOutline(5);
        var oTitle = new CTLText(_oPanelContainer, -250, -130, 500, 150, 50, "center", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_ARE_SURE, true, true, true, false);
