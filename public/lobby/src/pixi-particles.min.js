    ...
    return function() {
                    ...
                    return s(e, t), e.prototype.init = function() {
                        ...
                        for (var e, i, s, a, n, o = [], h = 0; h < t.length; ++h) {
                            ...
                            for (var l = 0; l < s.length; ++l)
                                if ("string" == typeof(a = s[l])) n.push(r.fromImage(a));
                                else if (a instanceof r) n.push(a);
                            else {
                                var p = a.count || 1;
                                ...
                                for (this._spawnTimer -= t; this._spawnTimer <= 0;) {
                                    ...
                                    if (this.particleCount >= this.maxParticles) this._spawnTimer += this._frequency;
                                        ...
                                        if (h = this.minLifetime == this.maxLifetime ? this.minLifetime : Math.random() * (this.maxLifetime - this.minLifetime) + this.minLifetime, -this._spawnTimer < h) {
                                            ...
                                            e = 0;
                                            for (var u = Math.min(this.particlesPerWave, this.maxParticles - this.particleCount); e < u; ++e)
                ...
                r = {
                    ...
                    createSteppedGradient: function(t, e) {
                        ...
                        for (var s = i, n = t[0], o = 1, h = t[o], l = 1; l < e; ++l) {
                            ...
                            var c = r.hexToRGB(n.value),
                                u = r.hexToRGB(h.value),
                                d = {};
        ...
        5: [function(t, e, i) {
            ...
            var a = t("./ParticleUtils"),
                ...
                h = new RegExp(["[01234567890\\.\\*\\-\\+\\/\\(\\)x ,]"].concat(o).join("|"), "g"),
                l = function(t) {
                    ...
                    return t.createList = function(e) {
                        if (Array.isArray(e.list)) {
                            var i = e.list,
                                s = void 0,
                                a = void 0;
                            if (a = s = new t(i[0].value, i[0].time, e.ease), i.length > 2 || 2 === i.length && i[1].value !== i[0].value)
                                for (var r = 1; r < i.length; ++r) s.next = new t(i[r].value, i[r].time), s = s.next;
