		...
		<div class="row">
			<div class="col-md-12">
                        <div class="row row-sm text-center">
                            <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-warning">
                                    <div class="h1 text-info font-thin h1"><?php echo e($stats['shops']); ?></div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><?php echo app('translator')->get('app.total_shops'); ?>
                                    <div class="icon">
						<i class="fa fa-sitemap"></i>
                            ...
                            <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-primary">
                                    <div class="h1 text-info font-thin h1"><?php echo e(($stats['agents'])); ?></div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><?php echo app('translator')->get('app.total_agents'); ?>
                                    <div class="icon">
						<i class="fa fa-user"></i>
                            ...
                            <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-info">
                                    <div class="h1 text-info font-thin h1"><?php echo e(($stats['distributors'])); ?></div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><?php echo app('translator')->get('app.total_distributors'); ?>
                                    <div class="icon">
						<i class="fa fa-user"></i>
					</div>
                                    </span>
                             ...
                             <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-primary">
                                    <div class="h1 text-info font-thin h1"><?php echo e(($stats['managers'])); ?></div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><?php echo app('translator')->get('app.total_managers'); ?>
                                    <div class="icon">
							<i class="fa fa-user"></i>
						</div>
                                    </span>
                	...
                	<?php if(auth()->user()->hasRole(['distributor','manager'])): ?>
                             <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-info">
                                    <div class="h1 text-info font-thin h1"><?php echo e(($stats['cashiers'])); ?></div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><?php echo app('translator')->get('app.total_cashiers'); ?>
                                    <div class="icon">
							<i class="fa fa-user"></i>
						</div>
                                    </span>
        	...
        	<?php if(auth()->user()->hasRole(['manager','cashier'])): ?>
                             <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-danger">
                                    <div class="h1 text-info font-thin h1"><?php echo e(($stats['users'])); ?></div>
                            ...
                            <div class="col-xs-6 col-lg-3">
                                <div class="panel padder-v item bg-danger">
                                    <div class="h1 text-info font-thin h1"><?php echo e(number_format( $stats['credit'], 2 )); ?></div>
                                    <span title="" data-original-title="Total active this month" class="text-muted text-xs"><?php echo app('translator')->get('app.total_credit'); ?>
                                    <div class="icon">
		...
		<div class="box box-primary">
			<div class="box-header with-border">
                ...
                <div class="pull-right box-tools">
                    ...
                    <?php if(auth()->user()->hasRole('admin')): ?>
                        <a href="<?php echo e(route('backend.shop.admin_create')); ?>" class="btn btn-primary btn-sm"><?php echo app('translator')->get('app.new_casino'); ?></a>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\vladimir.com\resources\views/backend/shops/list.blade.php ENDPATH**/ ?>