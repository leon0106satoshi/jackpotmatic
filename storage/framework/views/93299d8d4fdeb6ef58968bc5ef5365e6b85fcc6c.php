...
<header class="main-header">
    ...
    <a class="logo" href=" ">
        ...
        <span class="fa fa-btc">&nbsp;&nbsp;&nbsp;<b>ADMIN</b></span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
        ...
        <?php echo $__env->make('backend.partials.panic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php if(session()->exists('beforeUser')): ?>
      <li class="dropdown tasks-menu">
         <a href="#" class="dropdown-toggle" data-toggle="dropdown">
             <i class="glyphicon glyphicon-repeat text-aqua"></i></a>
...
<?php endif; ?>
    ...
    <li class="dropdown tasks-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="/frontend/euroslots/img/administrator.png" alt="..."></a>
        <ul class="dropdown-menu">
            <li class="header"><b><?php echo e(auth()->user()->username); ?></b></li>
            <li>
                <ul class="menu">
...
<?php if(Auth::user()->hasRole(['cashier'])): ?>
    ...
    <?php endif; ?>
<?php /**PATH W:\domains\vladimir.com\resources\views/backend/partials/navbar.blade.php ENDPATH**/ ?>