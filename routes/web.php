...
/*vltcash*/
    Route::get('vltcash/{userhash}', [
        'as' => 'frontend.vltcash.userhash',
        'uses' => 'ProfileController@vltcash'
    ]);
    ...
    */
    ...
    Route::any('game/{category}/{game}/merkur/{command}', [
        'as' => 'frontend.game.mercuryServer',
        'uses' => 'GamesController@merkur'
    ]);
...
// TERMINAL
    ...
    Route::get('/atm/delete/{id}/{api_id}', 'AtmController@deleteATM');	
        ...
        Route::get('/ticket_stat', [
            'as' => 'backend.ticket_stat',
            'uses' => 'DashboardController@ticket_stat',
        ]);
        Route::get('/live', [
        ...
        */
        ...
        'uses' => 'RefundsController@index',
        'middleware' => 'permission:refunds.manage',
    ]);
    Route::get('refunds/create', [
        'as' => 'backend.refunds.create',
        'uses' => 'RefundsController@create',
        'middleware' => 'permission:refunds.add',
    ]);
    Route::post('refunds/create', [
        'as' => 'backend.refunds.store',
        'uses' => 'RefundsController@store',
        'middleware' => 'permission:refunds.add',
    ]);
    Route::get('refunds/{refund}/edit', [
        'as' => 'backend.refunds.edit',
        'uses' => 'RefundsController@edit',
    ]);
	Route::post('refunds/{refund}/update', [
        'as' => 'backend.refunds.update',
        'uses' => 'RefundsController@update',
    ]);
	Route::delete('refunds/{refund}/delete', [
        'as' => 'backend.refunds.delete',
        'uses' => 'RefundsController@delete',
        ...
        Route::put('settings/delete/pay/stats', [
            'as' => 'backend.settings.gelete_pay',
            'uses' => 'SettingsController@gelete_pay',
            'middleware' => 'only_for_admin'
        ]);
