...
serverConfig = JSON.parse(fs.readFileSync('../public/socket2_config2.json', 'utf8'));
...
var privateKey = fs.readFileSync('ssl/jackpotmatic.net_le2.key', 'utf8');
var certificate = fs.readFileSync('ssl/jackpotmatic.net_le2.crt', 'utf8');
